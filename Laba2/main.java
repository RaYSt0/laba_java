...
public class main {
    ...
    public static class Refrigerator extends Appliance { // используется для обазначения наследия классов
        ...
        public Refrigerator(String brand, String model, double price, double capacity, boolean hasFreezer) {
            super(brand, model, price); // вызывает конструктор или метод суперкласса
            this.capacity = capacity; // вызывает текущий объект для ссылки внутри класса
